...
| **Delivered** | 2 | Message successfully delivered | Recipient receives the SMS |
...
Triggered when SMS delivery fails permanently.

### Parameters

| Parameter | Type | Description |
|:----------|:-----|:------------|
| `event` | string | "failed" or "delivererror" |
