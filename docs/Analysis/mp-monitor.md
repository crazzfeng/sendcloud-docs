...
5. Add the Aurora SendCloud monitoring email: **[sendcloudfbl@gmail.com](mailto:sendcloudfbl@gmail.com)**
...
<Accordion title="Google Postmaster Issues" icon="question-circle">
  ...
  * **Access denied**: Verify that [sendcloudfbl@gmail.com](mailto:sendcloudfbl@gmail.com) was added with proper permissions
