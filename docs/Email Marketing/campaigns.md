...
#Report of Campaign
Overview Provide the overall sending progress data, and support to view the sending status of the top five receiving domains.

Traking Statistics for you the task to open, click, unsubscribe, complaints and other data.
