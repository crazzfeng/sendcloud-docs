...
1. **Choose what to test**: Select which element you want to test. Options include:
   ...
   *Note: Each test supports up to 3 different variations.*
...
*Advanced settings are only available for regular email campaigns.*
...
- **Increases the rate every 24 hours** when delivery rate exceeds 85%
- **Decreases the rate every 24 hours** when delivery rate falls below 85%
