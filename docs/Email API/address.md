...
1. **Get the Code:** SendCloud provides you with a unique piece of **JavaScript code**
2. **Embed on Your Website:** Copy and paste this code into the HTML of the webpage where you want the subscription form to appear (e.g., homepage footer, blog sidebar)
3. **Frontend Display:** After embedding, an email input field will be displayed at the corresponding location on your website
4. **Address Collection:** When a visitor enters their email address and submits the form, it is automatically collected into a specified **target Address List** within your SendCloud account
