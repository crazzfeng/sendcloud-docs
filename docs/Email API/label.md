...
​​Tagging an Email​​
When sending an email via API, include the unique Label IDin your request parameters.
...
​​Typical Use Cases​​
​​A/B Testing:​​ Create different Labels (e.g., Campaign_A_Subject_1, Campaign_A_Subject_2) to track and compare the performance of various email versions.
​​Campaign Tracking:​​ Assign a unique Label to each marketing campaign (e.g., Q4_Promotion, Newsletter_January) for precise performance monitoring.
​​Segmenting Traffic:​​ Use Labels to categorize emails by type (e.g., Transactional_Password_Reset, Bulk_Newsletter) or by target user group.
​​Summary​​
