...
<Cards columns="2">
  <Card title="Login Password" icon="lock">
  ...
  <Card title="Mobile Phone" icon="mobile-alt">
    SMS verification codes sent to your bound mobile number
  </Card>
  <Card title="Google Authenticator" icon="shield-alt">
...
<Accordion title="Authentication Flow" icon="list-ol">
