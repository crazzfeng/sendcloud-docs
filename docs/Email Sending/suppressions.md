...
Some Mailbox Providers (like QQ Mail, Gmail) provide complaints via FBL (Feedback Loop) reports in ARF format.
​​Handling Mechanism:​​
Reported addresses are automatically added to the Complaint List.
​​Validity Period: 180 days​​.
Sending to addresses on this list during this period returns the error: "Blacklist:complaint (worker:address in complaint list)".
...
System auto-blocks subsequent sends, returning: "Blacklist: Bounce(worker:address in bounce list)".
​​Expiration Rules:​​
Mailbox Type
Expiration Policy
Max Duration
...
2^(n-1) days
30 days
​​Non-Tencent Mailboxes​​ 🌍
1h → 4h → 8h → 1d → 2^(n-1) days
180 days
...
📊 Filters invalid addresses effectively, helping maintain sending reputation.
⚙️ Supports querying and setting specific addresses to notbe blocked.
​​Unsubscribe List​​ ✋
​​Description:​​
