...
Log in to the SendCloud platform and navigate to **[Send Content] - [Email ]** from the left menu to access the template management page.
...
| **Invoke Name** 🔤   | Identifier used when making API calls | Must be unique           |
| **Subject** 📮       | Email subject line                    | Maximum 256 characters   |
| **Updated** ⏰        | Last modified time                    | Automatically logged     |
